...
class PredictionTestCase(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        # next rows
        (470, 0, sorted([4365, 4268, 4171, 4074])),
        (470, 10, sorted([4365, 4366, 4268, 4269, 4171, 4172, 4074, 4075])),
        (470, 990, sorted([4461, 4460, 4459, 4364, 4363, 4362, 4267, 4266, 4265, 4170, 4169, 4168])),
        (470, 1000, sorted([4461, 4460, 4364, 4363, 4267, 4266, 4170, 4169])),
        (470, 1010, sorted([4461, 4364, 4267, 4170])),
        # third-to-last row
        (509, 0, [4365]),
        (509, 10, [4365, 4366]),
        ...
        (509, 50, [4366, 4367, 4368, 4369, 4370]),
        (509, 1010, [4461]),
        (509, 1000, [4460, 4461]),
        (509, 990, [4459, 4460, 4461]),
        (509, 980, [4458, 4459, 4460, 4461]),
        (509, 970, [4457, 4458, 4459, 4460, 4461]),
        # second-to-last row
        (510, 0, []),
        # last row
        (511, 0, []),
